...
// // 삼각형 넓이 공식: 밑변 * 높이 / 2
// let triangleUnderLine = prompt('[문제 1] 삼각형의 밑변 입력')
// let triangleHeight = prompt('[문제 1] 삼각형의 높이 입력')
// let triangleWidth = triangleUnderLine * triangleHeight / 2
// console.log(`삼각형 넓이: ${triangleWidth}`)
...
// let celcius = prompt('[문제 2] 화씨 온도 입력')
// let changeFahrenheit = (celcius * 9 / 5) + 32
// console.log(`화씨 변환 결과: ${changeFahrenheit}`)
...
// let birthYear = prompt("[문제 3] 태어난 년도를 입력하세요")
// let age = 2025 - Number(birthYear)
// console.log(`당신의 나이: ${age}`)
...
// let kg = prompt("[문제 4] 몸무게 입력")
// let cm = prompt("[문제 4] 키 입력 (단위: cm)")
// let cmChange = parseFloat(cm / 100)
// let bmi = kg / ( cmChange * cmChange )
// console.log(`BMI 지수 결과: ${bmi}`)



// // 문제 5: 관리자 확인
// // 아이디와 이메일을 prompt 함수로 입력받습니다. 아이디가 'admin'이거나 또는 이메일이 'admin@test.com'이면 '관리자'를,그렇지 않으면 '일반 사용자'를 콘솔에 출력하는 프로그램을 작성하시오.
// let id = prompt("[문제 5] 아이디 입력")
// let email = prompt("[문제 5] 이메일 입력")
// let isManager = id == "admin" || email == "admin@test.com" ? '관리자' : '일반 사용자'
...
// let yourAge = prompt("[문제 7] 나이 입력")
// let congratulation = yourAge >= 20 & yourAge < 30 ? "이벤트 대상입니다." : "이벤트 대상이 아닙니다."
...
// let addTodo = prompt("[문제 9] 새로운 할 일 입력하기")
