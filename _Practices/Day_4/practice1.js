...
// // 어떻게 할 지 감이 안와서 무식하게 함 (6개의 경우의 수 <- 입력정수 하나라도 더 있으면 이런 짓 못 핟듯)
// // 임시 변수(temp)를 하나 만든 후, 변수에 담긴 정수의 값을 '스왑'하는 방법이 있음!
// // temp는 변수 교환 중 변수 하나가 소실되지 않기 위해 만든 임시 저장소 역할임
// // if (정수1 > 정수2) { let temp = 정수1; 정수1 = 정수2; 정수2 = temp } 
