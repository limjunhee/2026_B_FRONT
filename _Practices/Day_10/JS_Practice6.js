...
let result4 = findLongestWord(words)
console.log(result4)
...
function findTopStudent(arr){
    let highestStudent = arr[0];
    for (let i = 1; i <= arr.length - 1; i++){
        if(highestStudent.score < arr[i].score){
...
let result6 = findTopStudent(students)
console.log(result6)
...
let result7 = calculator(1, 2, '+')
let result8 = calculator(1, 2, '-')
