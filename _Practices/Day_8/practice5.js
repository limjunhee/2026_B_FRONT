...
// let productName = prompt("제품명 입력")
// let price = prompt("가격 입력")
// let manufacturer = prompt("제조사 입력")
// const product = {}
// // let product = {제품명,가격,제조사} <- 이런 식으로도 선언 가능
// product.제품명 = productName
// product.가격 = price
...
// let inputUserName = prompt("유저이름 입력")
// let id중복 = false

// // 아이디 중복 검사
// for (let index = 0; index < members.length; index++) {
//     if (members[index].id == inputId) {
//         id중복 = true
//         break
//     }
// }
...
// } else {
//     members.push({})
//     members[members.length - 1].id = inputId
//     members[members.length - 1].password = inputPassword
//     members[members.length - 1].name = inputUserName
// }
// console.log(members)
...
//     average += scores[index].math
// }
// average = parseInt(average / scores.length)
// console.log('모든 학생의 수학점수 평균: ' + average)
...
//         developers.push(team[i].name)
//     } else {
//         projectmanagers.push(team[i].name)
//     }
// }
// result.개발팀 = developers
// result.기획팀 = projectmanagers
...
//             finalPrice += (cart[i].quantity * productsInfo[j].price)
//         }
//     }
// }
...
// let html =  `<table>
//             <tr>
//                 <th>업소명</th> <th>세대수</th> <th>업소명</th> <th>세대수</th> <th>소재지</th> <th>지정메뉴</th> <th>전화번호</th> <th>업태</th>
//             </tr>`
